...
export default function Home() {
  return (
    <main>
      ...
      <section id="education" className="section shell two-column-section"><div><h2>Education</h2><div className="timeline-card"><span className="dot" /><div><div className="card-top"><h3>Bachelor&apos;s Degree in Information Technology</h3><span>2026</span></div><p>Alliance University, Bengaluru</p><strong>CGPA: 8.4</strong></div></div></div><div id="experience"><h2>Experience</h2><div className="timeline-card"><span className="dot" /><div><div className="card-top"><h3>Artificial Intelligence Intern</h3><span>07 Mar 2024 — 01 May 2024</span></div><p><strong>Rinex Technology</strong></p><ul><li>Successfully completed an Artificial Intelligence internship at Rinex.</li><li>Internship completion is supported by Certificate ID <strong>AI24-RNI0-3239</strong>.</li><li>Separate AI course certificate from Rinex records a Grade <strong>A+</strong>, Certificate ID <strong>AI24-RNC0-3239</strong>.</li></ul><span className="proof-pending">Certificate proof supplied by Vikas</span></div></div></div></section>
      ...
      <section id="certifications" className="section shell"><h2>Certifications &amp; Achievements</h2><div className="cert-grid">{certifications.map((cert) => <article className="cert-card" key={cert.title}><h3>{cert.title}</h3><p>{cert.issuer}</p><span className="proof-pending">{cert.proof}</span><small>{cert.note}</small></article>)}</div><div className="achievement-note"><h2>Achievements</h2><p>No achievements are published here without supporting proof. Verified certificates can be added as you provide them.</p></div></section>
